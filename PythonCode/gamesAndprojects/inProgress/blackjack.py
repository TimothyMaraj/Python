"""
   ...
   - look into oop versus proc for deck class
    ...
    - need to sort by number and by string
"""

""""
broke on these on follwoing conditions


User Cards:['Ace', 3, 4] User Count: 18
Bot Cards:[4, 2, 7] Bot Count: 13
Do you want a hit: no
User Cards:['Ace', 3, 4] User Count: 18
Bot Cards:[4, 2, 7, 8] Bot Count: 21
tie
...
class Deck(): 
    ...
    def __init__(self): 
        self.cardList = []
        self.OrginalcardList = [2,3,4,5,6,7,8,9,10,"Jack","Queen","King","Ace"] 


    def cardListFunction(self): 
        for i in range(0,52,1): 
            self.cardList.append(self.OrginalcardList[random.randrange(0,13,1)]) 
        print(self.cardList)
...
def tests(): 
    ...
    # some comment to test if i ma using git branch correectly